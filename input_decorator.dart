...
class _HelperErrorState extends State<_HelperError>
  ...
  void didUpdateWidget(_HelperError old) {
    ...
    final bool errorTextStateChanged = (newErrorText != null) !=
        (oldErrorText != null);
...
class _RenderDecoration extends RenderBox {
  ...
  TextAlignVertical get textAlignVertical {
    if (_textAlignVertical == null) {
      return _isOutlineAligned ? TextAlignVertical.center : TextAlignVertical
          .top;
    }
  ...
  _RenderDecorationLayout _layout(BoxConstraints layoutConstraints) {
    ...
    final double prefixIconHeight = prefixIcon == null ? 0 : prefixIcon.size
        .height;
    final double suffixIconHeight = suffixIcon == null ? 0 : suffixIcon.size
        .height;
    ...
    final double baselineAdjustment = fixAboveInput -
        overflow * (1 - textAlignVerticalFactor);
    ...
    final double textAlignVerticalOffset = maxVerticalOffset *
  ...
  double computeMinIntrinsicHeight(double width) {
    double subtextHeight = _lineHeight(
        width, <RenderBox>[helperError, counter]);
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (label != null) {
      ...
      final bool isOutlineBorder = decoration.border != null &&
...
class InputDecorator extends StatefulWidget {
  ...
  static RenderBox containerOf(BuildContext context) {
    final _RenderDecoration result = context.findAncestorRenderObjectOfType<
        _RenderDecoration>();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>(
        'baseStyle', baseStyle, defaultValue: null));
...
class _InputDecoratorState extends State<InputDecorator>
  ...
  void initState() {
    ...
    _floatingLabelController = AnimationController(
      ...
      value: (widget.decoration.hasFloatingPlaceholder &&
          widget._labelShouldWithdraw) ? 1.0 : 0.0,
    );
  ...
  void didUpdateWidget(InputDecorator old) {
    ...
    if (_floatingLabelController.isCompleted && errorText != null &&
  ...
  Color _getDefaultBorderColor(ThemeData themeData) {
    ...
    final Color enabledColor = themeData.colorScheme.onSurface.withOpacity(
        0.38);
    if (isHovering) {
  ...
  Color _getHoverColor(ThemeData themeData) {
    if (decoration.filled == null || !decoration.filled || isFocused ||
        !decoration.enabled)
      return Colors.transparent;
  ...
  TextStyle _getInlineStyle(ThemeData themeData) {
    return themeData.textTheme.subhead.merge(widget.baseStyle)
        .copyWith(color: decoration.enabled ? themeData.hintColor : themeData
        .disabledColor);
  }
  ...
  TextStyle _getHelperStyle(ThemeData themeData) {
    final Color color = decoration.enabled ? themeData.hintColor : Colors
        .transparent;
  ...
  TextStyle _getErrorStyle(ThemeData themeData) {
    final Color color = decoration.enabled ? themeData.errorColor : Colors
        .transparent;
    return themeData.textTheme.caption.copyWith(color: color).merge(
  ...
  Widget build(BuildContext context) {
    ...
    final Widget prefix = decoration.prefix == null &&
        decoration.prefixText == null ? null :
    _AffixText(
    ...
    final Widget suffix = decoration.suffix == null &&
        decoration.suffixText == null ? null :
    _AffixText(
      labelIsFloating: widget._labelShouldWithdraw,
    ...
    final bool decorationIsDense = decoration.isDense ==
        true; // isDense == null, same as false
    final double iconSize = decorationIsDense ? 18.0 : 24.0;
    final Color iconColor = isFocused ? activeColor : _getDefaultIconColor(
        themeData);
...
class InputDecoration {
  ...
  const InputDecoration({
    ...
    this.alignLabelWithHint,
      ...
      : assert(enabled != null),
        assert(!(prefix != null && prefixText !=
            null), 'Declaring both prefix and prefixText is not supported.'),
        assert(!(suffix != null && suffixText !=
            null), 'Declaring both suffix and suffixText is not supported.'),
        isCollapsed = false;
  ...
  ///Boolean to show asterisk symbol if field is mandatory
  ...
  bool operator ==(dynamic other) {
    ...
    return typedOther.icon == icon
        ...
        && typedOther.isMandatoryField == isMandatoryField
  ...
  String toString() {
    final List<String> description = <String>[
      ...
      if (isMandatoryField != null) 'isMandatoryField: "$isMandatoryField"',
      ...
      if (semanticCounterText !=
          null) 'semanticCounterText: $semanticCounterText',
...
class InputDecorationTheme extends Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>(
        'labelStyle', labelStyle, defaultValue: defaultTheme.labelStyle));
    properties.add(DiagnosticsProperty<TextStyle>(
        'helperStyle', helperStyle, defaultValue: defaultTheme.helperStyle));
    properties.add(IntProperty('helperMaxLines', helperMaxLines,
        defaultValue: defaultTheme.helperMaxLines));
    properties.add(DiagnosticsProperty<TextStyle>(
        'hintStyle', hintStyle, defaultValue: defaultTheme.hintStyle));
    properties.add(DiagnosticsProperty<TextStyle>(
        'errorStyle', errorStyle, defaultValue: defaultTheme.errorStyle));
    ...
    properties.add(DiagnosticsProperty<bool>(
        'isDense', isDense, defaultValue: defaultTheme.isDense));
    ...
    properties.add(DiagnosticsProperty<TextStyle>(
        'prefixStyle', prefixStyle, defaultValue: defaultTheme.prefixStyle));
    properties.add(DiagnosticsProperty<TextStyle>(
        'suffixStyle', suffixStyle, defaultValue: defaultTheme.suffixStyle));
    properties.add(DiagnosticsProperty<TextStyle>(
        'counterStyle', counterStyle, defaultValue: defaultTheme.counterStyle));
    properties.add(DiagnosticsProperty<bool>(
        'filled', filled, defaultValue: defaultTheme.filled));
    properties.add(ColorProperty(
        'fillColor', fillColor, defaultValue: defaultTheme.fillColor));
    properties.add(ColorProperty(
        'focusColor', focusColor, defaultValue: defaultTheme.focusColor));
    properties.add(ColorProperty(
        'hoverColor', hoverColor, defaultValue: defaultTheme.hoverColor));
    properties.add(DiagnosticsProperty<InputBorder>(
        'errorBorder', errorBorder, defaultValue: defaultTheme.errorBorder));
    properties.add(DiagnosticsProperty<InputBorder>(
    ...
    properties.add(DiagnosticsProperty<InputBorder>(
        'border', border, defaultValue: defaultTheme.border));
    properties.add(DiagnosticsProperty<bool>(
